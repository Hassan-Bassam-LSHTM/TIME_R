...
kneg <- logcurve(50,90,1985,2014,0.8,2)
kpos <- logcurve(50,90,1985,2014,0.8,2)
...
dstneg_n <- logcurve(0,5,1985,2014,1,2) 
dstneg_p <- logcurve(0,71,1985,2014,1,2) ###
dstpos_n <- logcurve(0,5,1985,2014,1,2) 
dstpos_p <- logcurve(0,71,1985,2014,1,2) ###
...
parms <- c(beta = 15, 
           ...
           ART_TB1 = 0.2040, ART_TB2 = 0.5540, ART_TB3 = 0.70, ART_mort1 = 0.2320, ART_mort2 = 0.6290, ART_mort3 = 0.7950,
           BCG_eff = 0.56,
