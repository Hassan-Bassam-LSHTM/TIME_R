...
# 100 equates to average of one year from disease to detection (in the absence of competing events)
kneg <- logcurve(50,100,1990,2012,0.8,2)
kpos <- logcurve(50,100,1990,2012,0.8,2)

# Relative rate of detection of smear neg
...
dstneg_n <- logcurve(0,130,1985,2014,1,2)
dstneg_p <- logcurve(0,69,1985,2014,1,2)
dstpos_n <- logcurve(0,130,1985,2014,1,2)
dstpos_p <- logcurve(0,69,1985,2014,1,2)
