...
kneg <- logcurve(70,150,1990,2012,0.8,2)
kpos <- logcurve(70,150,1990,2012,0.8,2)
...
dstneg_n <- cbind(seq(1970,2050),approx(c(1970,2008,2010,2012,2014,2050),c(0,0,0.5,0.5,0.95,0.95),seq(1970,2050),rule=2)$y)
dstneg_p <- cbind(seq(1970,2050),approx(c(1970,1979,2010,2012,2014,2050),c(0,0,0.5,0.5,0.95,0.95),seq(1970,2050),rule=2)$y)
dstpos_n <- cbind(seq(1970,2050),approx(c(1970,2008,2010,2012,2014,2050),c(0,0,0.5,0.5,0.95,0.95),seq(1970,2050),rule=2)$y)
dstpos_p <- cbind(seq(1970,2050),approx(c(1970,1979,2010,2012,2014,2050),c(0,0,0.5,0.5,0.95,0.95),seq(1970,2050),rule=2)$y)
...
parms <- c(beta = 17.5, 
           a_a = 0.15, a0 = 0.333, a5 = 0.177, a10 = 0.07,
           v = 0.001, 
           p = 0.65, 
           sig_a = 0.45, sig0 = 0.081, sig5 = 0.05, sig10 = 0.099, rel_inf = 0.25, theta = 0.02, r = 0.245,
           mu_N = 0.15, mu_N0 = 0.15, mu_N5 = 0.15, mu_N10 = 0.15,
           mu_I = 0.25, mu_I0 = 0.25, mu_I5 = 0.15, mu_I10 = 0.15, 
           fit_cost = fit_cost, e = e, g=g,
           eff_n = 0.61, eff_p = 0.45, 
           muN_H = 0.3, muI_H = 0.5, RR1a = 2.0, RR2a = 1.29, RR1v = 3.0, RR2v = 3.0, RR1p = 0.5, RR2p = 1.1,
           ART_TB1 = 0.3, ART_TB2 = 0.5, ART_TB3 = 0.65, ART_mort1 = 0.5, ART_mort2 = 0.6, ART_mort3 = 0.7,
           BCG_eff = 0.6,
           sig_H = 0.35,r_H=0.15,rel_inf_H=0.25,theta_H=0.02)
